...
import { useDeleteCategory } from "@/modules/admin/categories/features/edit_category/service";
  ...
  if (isLoading) {
    return (
      <div className="w-full max-w-4xl mx-auto px-4 py-8">
        <CustomHeader title="Eliminar Categoría" to={ROUTES.Admin.ViewCategories} />
